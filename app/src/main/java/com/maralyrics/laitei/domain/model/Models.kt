package com.maralyrics.laitei.domain.model
...
data class Song(
    ...
    val views: Int = 0,
    val artists: List<SongContributor> = emptyList(),
    val composers: List<SongContributor> = emptyList()
)

data class SongContributor(
    val id: Long? = null,
    val name: String,
    val slug: String
)
...
data class AppSettings(
    ...
    val privacyPolicyAcceptedAt: Long = 0L
)
...
data class SyncStatus(
    ...
    val newComposers: Int = 0,
    val newCopyrightOwners: Int = 0,
